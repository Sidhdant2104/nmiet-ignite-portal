    ...
    <div className="relative overflow-hidden pb-28 pt-32 lg:pt-40">
      ...
      <div className="shell max-w-3xl text-center">
        ...
        <section className="mt-14 text-left" aria-labelledby="next-steps-title">
          ...
          <p className="mt-7 text-center text-sm text-muted-foreground">Need assistance? Email <a className="font-semibold text-primary hover:underline" href="mailto:vivek.tapkire@nmiet.edu.in">vivek.tapkire@nmiet.edu.in</a> or Contact the SIH Coordinator.</p>
        </section>
